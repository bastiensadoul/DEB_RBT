...
EW_tW_gw150A=predict_WL(f_tW_gw150A, TC_gw150, tW_gw150A(:,1), par, cPar);
EW_tW_gw150B=predict_WL(f_tW_gw150B, TC_gw150, tW_gw150B(:,1), par, cPar);
EW_tW_gw150C=predict_WL(f_tW_gw150C, TC_gw150, tW_gw150C(:,1), par, cPar);

%-------------------------------------
% Study gw124ini

% let's try with saying that gw124ini is in days post birth (which I think it is)

tW_gw124iniA(:,1)=tW_gw124iniA(:,1)+64;
tW_gw124iniB(:,1)=tW_gw124iniB(:,1)+64;
tW_gw124iniC(:,1)=tW_gw124iniC(:,1)+64;

[EW_tW_gw124iniA, EL_gw124iniA]=predict_WL(f_tW_gw124iniA, TC_gw124, tW_gw124iniA(:,1), par, cPar);
[EW_tW_gw124iniB, EL_gw124iniB]=predict_WL(f_tW_gw124iniB, TC_gw124, tW_gw124iniB(:,1), par, cPar);
[EW_tW_gw124iniC, EL_gw124iniC]=predict_WL(f_tW_gw124iniC, TC_gw124, tW_gw124iniC(:,1), par, cPar);
