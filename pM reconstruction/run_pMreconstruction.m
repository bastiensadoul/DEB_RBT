%-------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Trajectory reconstruction for BPA
%-------------------------------------------------------------------------

clear all; close all; clc

global pets tpM
pets = {'pMreconstruction'};
...
load('results_pMreconstruction.mat');
...
% % Use the results which were saved in results_pMreconstruction.mat
