...
% 
% 
% data.tLW_ind = tLW_ind;
% units.tLW_ind = {'d', 'mm', 'g'};  label.tLW_ind = {'age since birth', 'length', 'wet weight'};  bibkey.tLW_ind = {'individual_data'};
%  temp.tLW_ind = C2K(8.5); units.temp.tLW_ind = 'K'; label.temp.tLW_ind = 'temperature';
% 
