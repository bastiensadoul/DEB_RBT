...
Wd_i = pars(:,17);
R_i = pars(:,18)./ c_T; % correct to reference temp
N_i = pars(:,19);
Wd_0 = pars(:,20);
...
%% R_i as function of L_inf
figure(); hold on
plot(log10(L_i(selM)), log10(R_i(selM)), 'k.', 'markersize', 8)
plot(log10(L_i(selB)), log10(R_i(selB)), 'bo', 'markersize',6,'markerfacecolor','b')
% plot(log10(L_i(selA)), log10(E_m(selA)), 'gs', 'markersize',12,'markerfacecolor','g')
plot(log10(L_i(selT)), log10(R_i(selT)), 'bs', 'markersize',12,'markerfacecolor','b')
% plot(log10(L_i(selM)), log10(22.5 * L_i(selM)/ 0.02), 'color',[0.7 0.7 0.7], 'linewidth',1, 'linestyle', '--')
xlabel('Ultimate struct. length, _{10}log L_i, cm')
ylabel('Max. reprod. rate. _{10}log [R_i], 1/d')
xlim([min(log10(L_i(selM))) max(log10(L_i(selM)))]  )
set(gca, 'FontSize', 15, 'Box', 'on')
saveas(gca,'figs/Li_Ri.png')

%% Wd_0 as function of L_inf
figure(); hold on
plot(log10(L_i(selM)), log10(Wd_0(selM)), 'k.', 'markersize', 8)
plot(log10(L_i(selB)), log10(Wd_0(selB)), 'bo', 'markersize',6,'markerfacecolor','b')
% plot(log10(L_i(selA)), log10(E_m(selA)), 'gs', 'markersize',12,'markerfacecolor','g')
plot(log10(L_i(selT)), log10(Wd_0(selT)), 'bs', 'markersize',12,'markerfacecolor','b')
% plot(log10(L_i(selM)), log10(22.5 * L_i(selM)/ 0.02), 'color',[0.7 0.7 0.7], 'linewidth',1, 'linestyle', '--')
xlabel('Ultimate struct. length, _{10}log L_i, cm')
ylabel('Egg dry weight _{10}log [Wd_0], g')
xlim([min(log10(L_i(selM))) max(log10(L_i(selM)))]  )
set(gca, 'FontSize', 15, 'Box', 'on')
saveas(gca,'figs/Li_Wd0.png')
