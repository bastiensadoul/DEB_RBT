...
% xlim([min(log10(p_M(selMollusca))) max(log10(p_M(selMollusca)))]  )
...
% plot(log10(Wd_i(selA)), log10(JT_Oi(selA)./ Wd_i(selA)),   'gs', 'markersize',12,'markerfacecolor','g')
...
% plot(log10(p_M(selA)), log10(a_m(selA)),   'gs', 'markersize',12,'markerfacecolor','g')
...
% plot(log10(p_M(selA)), log10(a_m(selA) .* c_T(selA)),   'gs', 'markersize',12,'markerfacecolor','g')
...
% plot(log10(L_i(selA)), log10(h_a(selA)),   'gs', 'markersize',12,'markerfacecolor','g')
...
% plot(log10(L_i(selA)), log10(p_M(selA)), 'gs', 'markersize',12,'markerfacecolor','g')
plot(log10(L_i(selT)), log10(p_M(selT)),'bs', 'markersize',12,'markerfacecolor','b')
plot([min(log10(L_i(selM))) max(log10(L_i(selM)))],[log10(18) log10(18)], 'r','linewidth',2)
xlabel('Ultimate struct. length, _{10}log L_i, cm')
...
plot([min(log10(L_i(selM))) max(log10(L_i(selM)))],[log10(0.02) log10(0.02)], 'r','linewidth',2)
xlabel('Ultimate struct. length, _{10}log L_i, cm')
...
% plot(log10(L_m(selMollusca)), log10(22.5 * L_m(selMollusca)), 'r','linewidth',2)
plot(log10(L_i(selM)), log10(22.5 * L_i(selM)), 'r','linewidth',2)
xlim([min(log10(L_i(selM))) max(log10(L_i(selM)))]  )
xlabel('Ultimate struct. length, _{10}log L_i, cm')
...
plot(log10(L_i(selM)),log10(0.275 * L_i(selM).^3), 'r','linewidth',2)
xlabel('Ultimate struct. length, _{10}log L_i, cm')
...
plot(log10(L_i(selM)),log10(166 * L_i(selM).^3), 'r','linewidth',2)
xlabel('Ultimate struct. length, _{10}log L_i, cm')
...
plot(log10(L_i(selM)), log10(22.5 * L_i(selM)/ 0.02), 'r','linewidth',2)
xlabel('Ultimate struct. length, _{10}log L_i, cm')
...
plot(log10(pMsurv_B(:,1)),pMsurv_B(:,2), 'r','linewidth',2)
...
plot(log10(vsurv_B(:,1)),vsurv_B(:,2), 'r','linewidth',2)
...
plot(kapsurv_B(:,1),kapsurv_B(:,2), 'r','linewidth',2)
