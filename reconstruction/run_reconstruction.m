...
% tf = round(linspace(64,421,)'); % choose the interval between knots which are estimated
...
estim_options('max_step_number',2e2); % change to 5e3 for the last round
...
estim_pars; close all;
estim_pars; close all;
estim_options('max_step_number',5e3); % change to 5e3 for the last round
estim_pars; 
% 
% %-------------------------------------------------------------------------
