...
par.z = 3.5915;       free.z     = 1;   units.z = '-';            label.z = 'zoom factor'; 
par.F_m = 6.5;        free.F_m   = 0;   units.F_m = 'l/d.cm^2';   label.F_m = '{F_m}, max spec searching rate'; 
par.kap_X = 0.8;      free.kap_X = 0;   units.kap_X = '-';        label.kap_X = 'digestion efficiency of food to reserve'; 
par.kap_P = 0.1;      free.kap_P = 0;   units.kap_P = '-';        label.kap_P = 'faecation efficiency of food to faeces'; 
...
par.E_Hb = 64.3957;   free.E_Hb  = 1;   units.E_Hb = 'J';         label.E_Hb = 'maturity at birth'; 
par.E_Hj = 389.0662;  free.E_Hj  = 1;   units.E_Hj = 'J';         label.E_Hj = 'maturity at metam'; 
par.E_Hp = 5252095.7886;  free.E_Hp  = 1;   units.E_Hp = 'J';         label.E_Hp = 'maturity at puberty'; 
par.h_a = 2.6245e-46;  free.h_a   = 1;   units.h_a = '1/d^2';      label.h_a = 'Weibull aging acceleration'; 
par.s_G = 10;         free.s_G   = 0;   units.s_G = '-';          label.s_G = 'Gompertz stress coefficient'; 


%% other parameters 
par.E_Hh = 11.6272;   free.E_Hh  = 1;   units.E_Hh = 'J';         label.E_Hh = 'maturity at hatch'; 
par.T_A = 13007.612;  free.T_A   = 1;   units.T_A = 'K';          label.T_A = 'Arrhenius temp'; 
par.T_ref = 293.15;   free.T_ref = 0;   units.T_ref = 'K';        label.T_ref = 'Reference temperature'; 
par.del_M = 0.051505;  free.del_M = 1;   units.del_M = '-';        label.del_M = 'shape coefficient'; 

% parameters which are estimated :
par.f_tW_gw124fin = 0.8319;  free.f_tW_gw124fin = 1;  units.f_tW_gw124fin = '-';  label.f_tW_gw124fin = 'scaled functional response for gw124fin'; 
par.f_tW_gw124iniA = 0.7618;  free.f_tW_gw124iniA = 1;  units.f_tW_gw124iniA = '-';  label.f_tW_gw124iniA = 'scaled functional response for gw124ini tank A'; 
par.f_tW_gw124iniB = 0.6915;  free.f_tW_gw124iniB = 1;  units.f_tW_gw124iniB = '-';  label.f_tW_gw124iniB = 'scaled functional response for gw124ini tank B'; 
par.f_tW_gw124iniC = 0.7557;  free.f_tW_gw124iniC = 1;  units.f_tW_gw124iniC = '-';  label.f_tW_gw124iniC = 'scaled functional response for gw124ini tank C'; 
par.f_tW_gw150A = 0.6005;  free.f_tW_gw150A = 1;  units.f_tW_gw150A = '-';  label.f_tW_gw150A = 'scaled functional response for gw150 tank A'; 
par.f_tW_gw150B = 0.6106;  free.f_tW_gw150B = 1;  units.f_tW_gw150B = '-';  label.f_tW_gw150B = 'scaled functional response for gw150 tank B'; 
par.f_tW_gw150C = 0.603;  free.f_tW_gw150C = 1;  units.f_tW_gw150C = '-';  label.f_tW_gw150C = 'scaled functional response for gw150 tank C'; 
par.f_ind = 1;  free.f_ind = 1;  units.f_ind = '-';  label.f_ind = 'scaled functional response for individual data'; 
